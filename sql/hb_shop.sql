...
CREATE TABLE `cart` (
  ...
  `productImage` varchar(50) COLLATE utf8mb4_general_ci NOT NULL
...
(134, 1, 21, 1, 'Áo sơ mi họa tiết CROPTOP', '1200000', 'a3.jpg');
...
(20, 2, '2024-06-05', '2024-11-23', 'Complete', 'Đỗ Kim Hoàn', '0987533117', ' hanoi'),
(21, 1, '2024-11-23', NULL, 'Processing', 'trịnh thanh minh', '0869915384', ' thanh hoa');
...
(24, 21, 19, 1, '600000', 'Áo sơ mi tay cánh tiên', 'a1.jpg'),
(25, 21, 21, 1, '1200000', 'Áo sơ mi họa tiết CROPTOP', 'a3.jpg');
...
CREATE TABLE `products` (
  ...
  `cateId` int NOT NULL,
  `qty` int NOT NULL,
  `des` varchar(1000) COLLATE utf8mb4_general_ci NOT NULL,
...
(2, 'trinhthanhminh36@gmail.com', 'trinhthanhminh', '2003-07-19', '0cc175b9c0f1b6a831c399e269772661', 2, 1, 'Hà Nội', 1, '56666'),
